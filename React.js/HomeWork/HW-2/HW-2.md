...
Для этого необходимо дополнить проект, созданный в предыдущем домашнем задании [homework1](../HW-1/HW-1.md).
...
- С помощью AJAX (fetch) запроса получить данные из массива товаров, записать в локальное состояние (state) компонента главной страницы.
...
- При нажатии на кнопку `Add to cart` должно появляться модальное окно с подтверждением добавления товара в корзину (используйте соответствующий компонент из [homework1](../hHW-1/HW-1.md).
